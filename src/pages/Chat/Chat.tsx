...
export default function StockAnalysisChat() {
     ...
     const stockSuggestions = [
          ...
          { text: "Market outlook for Q4 2024", icon: <Globe className="w-4 h-4" />, color: "from-orange-500 to-orange-600" },
     ]

     // Mock responses for different queries
     // eslint-disable-next-line @typescript-eslint/no-explicit-any
     const getMockResponse = (userMessage: string): { content: string; stockData?: any } => {
                    ...
                    <div className="bg-white/80 backdrop-blur-xl border-b border-red-100/50 p-6 shadow-sm">
                         <div className="flex items-center justify-between">
                              <div>
                                   ...
                                   <p className="text-gray-600 mt-1">Get intelligent insights powered by advanced AI</p>
                              </div>
                         ...
                         <div className="max-w-4xl mx-auto">
                              ...
                              <div className="flex gap-2 mt-4">
                                   <Button
                                        ...
                                        onClick={() => handleSuggestionClick("Analyze TSLA stock performance")}
                                   >
                                        📈 Analyze TSLA
                                   </Button>
                                   <Button
                                        ...
                                        size="sm"
                                        className="text-xs border-red-200 text-red-600 hover:bg-red-50 rounded-full"
                                        onClick={() => handleSuggestionClick("What are the top tech stocks to watch?")}
                                   >
                                        📊 Market Summary
                                   </Button>
                                   <Button
                                        ...
                                        size="sm"
                                        className="text-xs border-red-200 text-red-600 hover:bg-red-50 rounded-full"
                                        onClick={() => handleSuggestionClick("Market outlook for Q4 2024")}
                                   >
                                        💼 Portfolio Review
                                   </Button>
                              </div>
